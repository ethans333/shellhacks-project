      ...
      <div>
        <div className="center-page">
          ...
          <div className="text-center text-gray-400 font-weight-light mt-10 w-3/4 lg:w-full">
            ...
            Freedom Starts Here Upload Hero Image from Assets Folder Button Get
            Started
          </div>
          <div className="grid mt-32 grid-cols-1 lg:grid-cols-2 lg:w-3/5 mx-10">
            ...
            <div className="mt-5 pb-16 lg:pb-24">
              ...
              budgeting tools, multilingual support, and the scalability of AWS
              services.
            </div>
          </div>
          <div className="grid py-16 lg:pt-24 grid-cols-1 lg:grid-cols-2 lg:w-3/5 mx-10 border-t">
            <div>
              Knowledge Tailored to You: Tell us about your financial goals, and
              we'll curate personalized financial education modules just for
              you. Whether you're saving for college, buying a home, or securing
              your retirement, our resources will guide you every step of the
              way.
            </div>
          ...
          <div className="grid py-16 lg:pt-24 grid-cols-1 lg:grid-cols-2 lg:w-3/5 mx-10 border-t">
            ...
            <div className="mt-5 pb-16 lg:pb-24">
              ...
              financial management into a breeze. Set budgets, track income and
              expenses effortlessly, and receive real-time alerts to keep you on
          ...
          <div className="grid pt-16 lg:pt-24 pb-16 grid-cols-1 lg:grid-cols-2 lg:w-3/5 mx-10 border-t">
            ...
            <div className="mt-5 pb-16 lg:pb-24">
              ...
              Amazon S3, and Amazon RDS, ensuring not just scalability but also
              top-tier security and reliability. Your financial data is safe
              with us.{" "}
            </div>
          </div>
